...
for log_dir in log_dirs:
    try:
        train_actuator_network_and_plot_predictions(log_dir_root, log_dir[len(log_dir_root):], actuator_network_path=actuator_network_path, load_pretrained_model=load_pretrained_model)
