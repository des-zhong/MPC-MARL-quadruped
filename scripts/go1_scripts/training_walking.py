...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Train Go1 walking with normalized command-scale rewards.")
    ...
    parser.add_argument("--project", default=None, help="W&B project; defaults to walking.")
    parser.add_argument("--resume", action="store_true", help="Resume the configured walking checkpoint.")
    parser.add_argument("--resume-run", default="des_zhong/walking/runs/wgacdxwh")
...
def train_robot(args=None, headless=True):
    ...
    from dribblebot.envs.go1.walk_tracking import VelocityTrackingEasyEnv
    ...
    wandb.init(
      ...
      project=args.project or "walking",
