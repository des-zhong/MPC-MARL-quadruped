...
if __name__ == "__main__":
    ...
    from dribblebot_learn.ppo import Runner
    from dribblebot.envs.wrappers.history_wrapper import HistoryWrapper
    from dribblebot_learn.ppo.actor_critic import AC_Args

    from dribblebot.envs.base.legged_robot_config import Cfg
    from dribblebot.envs.mini_cheetah.mini_cheetah_config import config_mini_cheetah
