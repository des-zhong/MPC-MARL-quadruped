...
from dribblebot.envs.base.legged_robot_walk import LeggedRobot


class VelocityTrackingEasyEnv(LeggedRobot):
    """AS2 walking environment backed by the shared quadruped task."""
    ...
    def step(self, actions):
        ...
        self.extras.update({
            ...
            "joint_vel_target": torch.zeros(self.num_actions),
            ...
            "contact_states": (self.contact_forces[:, self.feet_indices, 2] > 1.0).detach().cpu().numpy().copy(),
